                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-6 d-flex d-sm-block flex-column align-items-center'>
                            ...
                            <h1 className='mb-5 text-black fw-bold text-center text-sm-start'>A1 Restaurant</h1>
                            <MenuBtn />
                        </div>
                    </div>
                </div>
            ...
            <div className='container my-5'>
                <div className='row'>
                    ...
                    <div className='col-lg-6 d-flex flex-column align-items-center justify-content-center'>
                        ...
                        <p>Welcome to A1 Restaurant, where delicious flavors meet a warm and inviting ambiance! Our passion for exceptional food and outstanding service makes every dining experience special
                        Whether you're craving a hearty meal, a light bite, or a sweet treat, A1 Restaurant is the perfect place to enjoy quality food with family and friends. Come and experience the best flavors in town!
                        </p>
                        <Link to="/about">
                        ...
                        <div className='col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0'>
                            ...
                            <ul className='px-0'>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Burger</p>
                        ...
                        <div className='col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0'>
                            ...
                            <ul className='px-0'>
                                <li className='d-flex justify-content-between'>
                                    ...
                                    <p className='fs-3 mx-2 text-success fw-nold'>Rs.40</p>
                                </li>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Fruit Juice</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>Rs.20</p>
                                </li>
                                <li className='d-flex justify-content-between'>
